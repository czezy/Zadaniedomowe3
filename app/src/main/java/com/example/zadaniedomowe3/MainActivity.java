...
public class MainActivity extends AppCompatActivity implements SensorEventListener
{
    ...
    //private ObjectAnimator leftBallAnimator;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                locked = false;
                button.setVisibility(View.INVISIBLE);
                ballImage.setImageDrawable(getResources().getDrawable(R.drawable.hw3ball_front));
                ballText.setText("");
            }
        });

        //screenWidth = findViewById(R.id.constraintLayout).getWidth(); //layout jeszcze nie wyrysowany - nie można pobrać szerokości. Należałoby ustawić onGlobalLayout listenera,
        //ballWidth = ballImage.getWidth();                             //aby pobrać szerokości, gdy są gotowe
        start = ballImage.getX();

        left = start - 30; //(screenWidth - ballWidth)/2;
        right = start + 30; //(screenWidth - ballWidth)/2;
            ...
            sensorText.setText(String.valueOf(percent));
                ...
                else
                {
                    if (percent < 0.003)
                    {
                        ...
                        vibrator.cancel();
                        ballImage.setImageDrawable(getResources().getDrawable(R.drawable.hw3ball_empty));
